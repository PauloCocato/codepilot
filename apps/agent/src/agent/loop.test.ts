...
vi.mock("../indexer/embeddings.js", () => ({
  ...
  createEmbeddingAdapter: (...args: unknown[]) =>
    mockCreateEmbeddingAdapter(...args),
}));
...
function setupHappyPath(): void {
  ...
  mockCloneRepo.mockResolvedValue({
    path: "/tmp/codepilot/acme-webapp-abc",
    defaultBranch: "main",
  });
  ...
  mockGenerateBranchName.mockReturnValue(
    "codepilot/issue-42-fix-login-redirect",
  );
  ...
  mockCreatePR.mockResolvedValue({
    prUrl: "https://github.com/acme/webapp/pull/99",
    prNumber: 99,
  });
